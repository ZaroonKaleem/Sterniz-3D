...
const CleaningServices = () => {
  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col">
        <VerticalTimeline>
          {/* First Cleaning Service - Cleaning and service */}
          <VerticalTimelineElement
            contentStyle={{
              background: "#222a49",
              color: "#fff",
          ...
          >
            <div>
              <h3 className="text-white text-[24px] font-bold">
                {t('CleaningAndService')}
              </h3>
            </div>
            <ul className="mt-5 list-disc ml-5 space-y-2">
              <li className="text-white-100 text-[14px] pl-1 tracking-wider">
                {t('CleaningAndServiceP')}
              </li>
            </ul>
          </VerticalTimelineElement>

          {/* Second Cleaning Service - Maintenance cleaning */}
          <VerticalTimelineElement
            contentStyle={{
              background: "#222a49",
              color: "#fff",
