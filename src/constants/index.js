...
export const facilityManagementExperiences = [
  {
    ...
    points: [
      ...
      "Ensuring safe and efficient facility operations.",
      "Emergency repair services and preventative maintenance.",
    ],
  },
  {
  ...
  //   date: "2019 - Present",
  //   points: [
  //     "Reducing energy consumption and improving sustainability.",
  //     "Smart building solutions and renewable energy integration.",
  //     "Waste management and eco-friendly initiatives.",
  //   ],
  // },
];
